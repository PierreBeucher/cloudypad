 ...
 * 
 * @export
 * @interface MachinesListDefaultResponse
 */
export interface MachinesListDefaultResponse {
    /**
     * 
     * @type {string}
     * @memberof MachinesListDefaultResponse
     */
    'message': string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<MachinesListDefaultResponseIssuesInner>}
     * @memberof MachinesListDefaultResponse
     */
    'issues'?: Array<MachinesListDefaultResponseIssuesInner>;
}
/**
 * 
 * @export
 * @interface MachinesListDefaultResponseIssuesInner
 */
export interface MachinesListDefaultResponseIssuesInner {
    /**
     * 
     * @type {string}
     * @memberof MachinesListDefaultResponseIssuesInner
     */
    'message': string;
}
/**
...
export const MachineApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        machinesList: async (after?: string, limit?: number, orderBy?: MachinesListOrderByEnum, order?: MachinesListOrderEnum, name?: string, region?: string, agentType?: string, machineType?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/machines`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const MachineApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async machinesList(after?: string, limit?: number, orderBy?: MachinesListOrderByEnum, order?: MachinesListOrderEnum, name?: string, region?: string, agentType?: string, machineType?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MachinesList200Response>> {
...
export const MachineApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        machinesList(after?: string, limit?: number, orderBy?: MachinesListOrderByEnum, order?: MachinesListOrderEnum, name?: string, region?: string, agentType?: string, machineType?: string, options?: any): AxiosPromise<MachinesList200Response> {
...
export class MachineApi extends BaseAPI {
     ...
     * @memberof MachineApi
     */
    public machinesList(after?: string, limit?: number, orderBy?: MachinesListOrderByEnum, order?: MachinesListOrderEnum, name?: string, region?: string, agentType?: string, machineType?: string, options?: RawAxiosRequestConfig) {
...
export const OperationsApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async machinesRestart(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MachinesCreate200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.machinesRestart(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['OperationsApi.machinesRestart']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Starts a machine.
        ...
        async machinesStart(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MachinesCreate200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.machinesStart(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['OperationsApi.machinesStart']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Stops a machine.
        ...
        async machinesStop(id: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MachinesCreate200Response>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.machinesStop(id, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['OperationsApi.machinesStop']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export class OperationsApi extends BaseAPI {
     ...
     */
    public machinesRestart(id: string, options?: RawAxiosRequestConfig) {
        return OperationsApiFp(this.configuration).machinesRestart(id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public machinesStart(id: string, options?: RawAxiosRequestConfig) {
        return OperationsApiFp(this.configuration).machinesStart(id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public machinesStop(id: string, options?: RawAxiosRequestConfig) {
        return OperationsApiFp(this.configuration).machinesStop(id, options).then((request) => request(this.axios, this.basePath));
    }
}
