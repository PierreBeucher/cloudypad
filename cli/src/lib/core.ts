...
import { BOX_KIND_LINUX_NIXOS, NixOSBoxManager } from '../boxes/nix/manager.js'
import { BOX_KIND_GAMING_WOLF, WolfBoxManager } from '../boxes/gaming/manager.js'
import { BOX_KIND_LINUX_REPLICATED_NIXOS, ReplicatedNixOSBoxManager } from '../boxes/nix/replicated-manager.js'
